      ...
      <section id="recursos" className="py-24 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => <Card key={index} className="group p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <ul className="space-y-4 mb-8">
                {["Confirmação automática de consultas", "Lembretes 24h e 2h antes", "Reagendamento pelo WhatsApp", "Coleta de feedback automática", "Redução de 80% nos no-shows"].map((item, index) => <li key={index} className="flex items-center space-x-3">
      ...
      <section id="beneficios" className="py-24 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => <Card key={index} className="p-6 text-center hover:shadow-lg transition-all duration-300">
