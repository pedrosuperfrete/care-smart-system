-- Corrigir usuários órfãos e problemas de estrutura

-- 1. Associar usuários órfãos a uma clínica padrão
-- Primeiro, verificar se há uma clínica padrão disponível
DO $$
DECLARE
  ...
  LOOP
    ...
    VALUES (
      ...
      CASE 
        ...
        ELSE usuario_sem_clinica.tipo_usuario
      END
    );
